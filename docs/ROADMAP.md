...
Current status: implemented as a source checkout and validated as a packed
npm tarball in a clean consumer environment; not yet published or
release-prepared. See `docs/CURRENT_STATE.md` for the implementation summary.
